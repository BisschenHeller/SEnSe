...
public class ParcourObject : CollidableElement
{
    ...
    {
        Vector3 ret = new Vector3(0, worldHeight, 0);
    ...
    public void OnDrawGizmosSelected()
    {
        ...
        Gizmos.DrawWireCube(new Vector3(transform.position.x, worldHeight - transform.localScale.y/2, transform.position.z), new Vector3(gizmoScale.x, 0.01f, gizmoScale.y));
